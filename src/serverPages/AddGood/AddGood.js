    ...
    return (
      <div className='AddGoods'>
        ...
        >
          ...
          <div className='infoLine'>
            <div className='addGoodstitle'>热度</div>
            <div className='infoInput'>
              <Input value={formData.hot}
                type='number'
                onChange={(e) => {
                  this.setState({
                    formData: Object.assign({}, this.state.formData, { hot: e.target.value })
                  })
                }}
                placeholder='请输入排序热度（数字）'
              ></Input>
            </div>
          </div>
          <div className='infoLine'>
            ...
            <div className='infoInput'>
              <TextArea value={formData.custom_data}
                onChange={this.handlecustomChange} placeholder='请输入富文本'></TextArea>
            </div>
          </div>
